...
export default function SellerHistoryContent() {
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8 bg-[#FDFDFD] min-h-screen">
            {/* Top Header */}
            <div className="flex justify-between items-start">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Log Riwayat Seller</h1>
                    <p className="text-gray-400 mt-1 font-medium">Ringkasan hasil penjualan hari ini</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-8 rounded-[32px] text-white shadow-lg shadow-orange-100 relative overflow-hidden group">
                    <div className="relative z-10">
                        <p className="text-orange-100 text-sm font-semibold mb-3">Rata-rata Penjualan</p>
                ...
                {/* Total Products */}
                <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                    <p className="text-gray-400 text-sm font-semibold mb-3">Total Varian</p>
                    <div className="flex items-baseline gap-2">
            ...
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                <div className="flex justify-between items-center mb-10">
                    <h3 className="text-xl font-bold text-gray-900">Grafik Riwayat</h3>
            ...
            <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-8 border-b border-gray-50">
                    <h3 className="text-xl font-bold text-gray-900">Daftar Riwayat Pesanan</h3>
                </div>
                ...
                <div className="p-8 border-t border-gray-50 flex items-center justify-between">
                    <p className="text-sm font-bold text-gray-400">Menampilkan 3 dari 45 Riwayat</p>
                    <div className="flex gap-3">
